 ...
 * @version 1.0
 */
public class RequesterCallBack extends RequestCallBack<String> {
	...
	public RequesterCallBack(HttpCallback callBack) {
		super();
		this.callBack = callBack;
	}

	public RequesterCallBack(HttpCallback callBack, int flag) {
		super();
		this.flag = flag;
		this.callBack = callBack;
	}
